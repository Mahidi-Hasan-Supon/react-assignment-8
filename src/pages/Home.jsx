    ...
    return (
        <div className='my-5'>
           ...
           <div>
            ...
            <p className='text-center opacity-40 my-4'>Explore All Trending Apps on the Market developed by us</p>
            <div className='grid md:grid-cols-4 gap-10 my-10'>
                {
                  eightApp.map(eight=><EightApp key={eight.id} eight={eight}></EightApp>)
                }
            </div>
           <div className='flex justify-center'>
             <Link to='/apps' className='btn text-center  text-white  bg-linear-65 from-[#632EE3] to-[#9F62F2]'>Show All</Link>
           </div>
           </div>
        </div>
    );
