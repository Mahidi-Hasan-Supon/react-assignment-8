    ...
    return (
        <div className='my-10'>
         ...
         <div className='flex justify-between my-5 ml-7 mr-7'>
            <h1 className='text-xl font-semibold'>({installed.length}) Apps Found</h1>
          <label htmlFor="">
            ...
            {setSortApp().map(a=>(<div key={a.id} className=' bg-white shadow ml-7 mr-7 rounded-lg my-5'>
                  <div className='md:flex'>
                      <div>
                        <img className='h-[80px] w-[80px] ml-2 py-1' src={a.image} alt="" />
                    </div>
                    <div className='flex md:justify-between items-center ml-5'>
                        <div className=''>
                            <h1 className='font-semibold'>{a.title}</h1>
                            <div className='flex gap-5'>
                                <p className='text-[#00D390] flex items-center gap-1'> <RxDownload/> {a.downloads}M</p>
                                <p className='text-[#FF8811] flex items-center gap-1'><FaStar></FaStar> {a.ratingAvg}</p>
                                <p className='opacity-60'>{a.size}MB</p>
                              
                            </div>
                        </div>
                        <div className='md:ml-320 ml-10'>
                            <button onClick={()=>removeApp(a.id)} className='btn bg-[#00D390] text-white'> Uninstall</button>
                        </div>
                    </div>
                  </div>
                </div>))
